...
///
/// First screen of the "Choose language -> Choose artists -> Choose
/// genres" onboarding flow, shown right after a successful login/signup
/// (before the person ever sees Home) — mirrors Spotify's own first-run
